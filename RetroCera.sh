...
rp_module_repo="git https://github.com/batocera-linux/batocera-emulationstation master"
...
function build_emulationstation() {
    ...
    if [[ -f "$md_build/emulationstation" ]]; then
        md_ret_require="$md_build/emulationstation"
    elif [[ -f "$md_build/es-app/src/emulationstation" ]]; then
        md_ret_require="$md_build/es-app/src/emulationstation"
    fi
}
